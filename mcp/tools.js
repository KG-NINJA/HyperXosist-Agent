...
const EXECUTE_OUTPUT_SCHEMA = {
  ...
  properties: {
    ...
    version: { type: 'string' },
    ok: { type: 'boolean' },
    stage: { enum: ['payment_required', 'completed', 'failed', 'outcome_unknown'] },
    status: { type: 'integer' },
    paid: { type: ['boolean', 'null'], description: 'Legacy report flag: true means server-reported settlement; null means unknown, not unpaid. Never independent chain evidence.' },
    paymentRequired: { type: 'boolean' },
    paymentAttempted: { type: 'boolean' },
