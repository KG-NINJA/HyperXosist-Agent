...
try{
 ...
 await writeFile(join(out,'result.json'),JSON.stringify({passed,console_errors:errors,requests:calls,real_payment:false,seller_requests:0,csp_present:true,viewports:[[1365,1000],[390,844]]},null,2));
